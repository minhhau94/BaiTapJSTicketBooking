    ...
    chairList: [
        ...
        },
        {
            ...
            "danhSachGhe": [
                ...
                { "soGhe": "B11", "gia": 75000, "daDat": true },
...
export const chairReducer = (state = initialState, action) => {
    switch (action.type) {
        case 'CHANGE_CHAIR': {
            ...
            // kiểm tra trong mảng chairSelected có tồn tại ghé hay chưa
            // findindex: nếu có trả về index của item đúng điều kiện, ngược lại trả về -1
